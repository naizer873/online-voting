...
<div class="side-bar" 
            style="background-color:rgb(255,105,180); font-size:25px; text-align:center; margin-top:-10px; padding-top:20px; padding-bottom:0px;">
        ...
        <nav class="nav-menue">
            <ul>
                ...
                <li><a href="../about.php">MKUSU</a></li>
