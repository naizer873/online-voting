                    ...
                    <div class="form-panel"><center>
                        ...
                        <form role="form" method = "post" enctype = "multipart/form-data" class="index-form">
                            ...
                            <center>Student Login</center>
                             ...
                             <br/>
                                <center><button class="btn btn-lg btn-pink btn-block " name = "login" style= " margin-bottom:0px;" width="50">Login</button>
                                &nbsp; 
                            <a  href="register/index.php"><button type="button" class="btn btn-lg btn-pink btn-block" data-dismiss="modal" style= " margin-bottom:0px;">Register</button></a>
