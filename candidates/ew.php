...
<body>
    ...
    <heading class="voters_heading">
        <center><h1>Registered Entertainment & Welfare Secretary Candidates</h1>
           <center>
                <select onchange = "page(this.value)">
                <option disabled selected>Select Candidate Group</option>
                <option value = "ch.php">Chairperson</option>
                <option value = "vc.php">Vice Chairperson</option>
                ...
                <option disabled selected>Entertainment & Welfare Secretary</option>
